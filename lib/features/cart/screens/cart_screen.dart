                      ...
                      Column( children: [
                        ...
                        InkWell(onTap: () {
                              ...
                              for(int index = 0; index < sellerGroupList.length; index++) {
                                ...
                                print("==Loop==>>$index");
                                print("==length==>>${sellerGroupList.length}");

                                // print("===StockOut===>>${sellerGroupList[index].quantity}");
                                // print("===StockOut===>>${sellerGroupList[index].productInfo!.totalCurrentStock!}");
